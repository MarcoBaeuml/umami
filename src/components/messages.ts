export const labels: Record<string, string> = {
  ...
  triggerConfig: 'label.trigger-config',
  urlPattern: 'label.url-pattern',
  matchType: 'label.match-type',
  selector: 'label.selector',
  delay: 'label.delay',
  seconds: 'label.seconds',
  urlTrigger: 'label.url-trigger',
  clickTrigger: 'label.click-trigger',
  pageviewTrigger: 'label.pageview-trigger',
  formTrigger: 'label.form-trigger',
  timerTrigger: 'label.timer-trigger',
